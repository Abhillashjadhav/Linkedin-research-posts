...
def _task(
    ...
    return (
        ...
        "Preserve an incident-first opening with simple, human language. LINE 1 MUST lead with "
        "the strongest supported recognisable name, incident, number or scale. LINE 2 MUST "
        "state the immediate reader consequence, useful artifact, or decision payoff. Never "
